    ...
    return (
      <div>
        ...
        <p className='text-normal justify-text marginBottom0'>
          ...
          It was a personal project that I decided to work on in order to keep myself busy 
        ...
        personal project. Because of that it played an important role on making me enjoy Computer Science more.
